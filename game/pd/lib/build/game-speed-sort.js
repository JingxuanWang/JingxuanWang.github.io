...
game.data.title = "分门别类";
var imgSize = 160;
//var yPositionAdjuster = getAspectRatio() < 0.58 ? -120 : 0;
var yPositionAdjuster = -120;
...
var Round = me.Container.extend({
    ...
    _init: function() {
        ...
        this.leftSprite = new Fruit(
            ...
            0,
            game.data.screenHeight - 2 * imgSize + yPositionAdjuster,
            imgSize
        );

        this.rightSprite = new Fruit(
            this.elems[this.rightId],
            game.data.screenWidth - imgSize - (220 - imgSize),
            game.data.screenHeight - 2 * imgSize + yPositionAdjuster,
            imgSize
        );

        this.leftSprite.open();
        this.leftSprite.setDefaultSize();
        this.rightSprite.open();
        this.rightSprite.setDefaultSize();
        ...
        this.leftArrow = new Arrow(
            ...
            this.leftSprite,
            0,
            game.data.screenHeight - imgSize + yPositionAdjuster,
            imgSize,
            imgSize,
    ...
    _spawn: function(index)
    {
        ...
        var sprite = new Fruit(
            this.elems[id],
            this.headX - (220 - imgSize) / 2,
            this.headY - imgSize / 4 * index + yPositionAdjuster,
            imgSize
        );
